...
class InferenceWrapper(inference_wrapper_base.InferenceWrapperBase):
 ...
 def build_model(self,model_config):
  ...
  model.build()
  return model
 def feed_image_and_attribute(self,sess,encoded_image,attribute):
  initial_state=sess.run(fetches="lstm/initial_state:0",feed_dict={"image_feed:0":encoded_image,"attribute_feed:0":attribute})
